...
public class SwaggerConfig {
	...
	private ApiInfo getApiInfo() {
		...
		return new ApiInfoBuilder()
				.title("Stack Simlplify User Management Service")
				.description("This page lists all  API's of User Management")
				.version("0.0.1Alpha")
				.contact(new Contact("Felix Leon","http://stacksimplify.com","stacksimplify@gmail.com"))
				.license("License2.0")
				.licenseUrl("http://stacksimplify.com/license.html")
				.build();
